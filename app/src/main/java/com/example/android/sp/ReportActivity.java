...
public class ReportActivity extends AppCompatActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, LocationListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SupportMapFragment mapFragment =       //Load the fragment with the google map
                (SupportMapFragment) getSupportFragmentManager().findFragmentById(R.id.reportmap);
    ...
    public void showForm(View v){
        ...
        intent.putExtra("lats",Double.toString(cameracenter.latitude));
    ...
    public void backtologin(View view){
        ...
        Intent intent3 = new Intent(ReportActivity.this, LoginActivity.class);  //pass intent to login activity
